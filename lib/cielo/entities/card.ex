...
defmodule Cielo.Entities.CreditCardReneval do
  use Cielo.Entities.Base
...
defmodule Cielo.Entities.CreditCardWithoutCVV do
  use Cielo.Entities.Base
  ...
  def changeset(card, attrs) do
    ...
    |> validate_required([:brand, :card_number, :expiration_date, :holder])
  end
end
